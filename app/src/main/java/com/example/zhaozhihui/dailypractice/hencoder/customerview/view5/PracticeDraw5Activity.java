package com.example.zhaozhihui.dailypractice.hencoder.customerview.view5;
...
public class PracticeDraw5Activity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, PracticeDraw5Activity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practice_draw5);
