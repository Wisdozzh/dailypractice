package com.example.zhaozhihui.dailypractice.hencoder.customerview.view7;
...
public class PracticeDraw7Activity extends AppCompatActivity {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, PracticeDraw7Activity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practice_draw7);
