package com.example.zhaozhihui.dailypractice.hencoder.customerview.view4;
...
public class PracticeDraw4Activity extends AppCompatActivity {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, PracticeDraw4Activity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practice_draw4);
