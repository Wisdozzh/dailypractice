package com.example.zhaozhihui.dailypractice.hencoder.customerview.view7.practice.practice06;
    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe keyframe1 = Keyframe.ofFloat(0, 0);//开始：progress为0
                Keyframe keyframe2 = Keyframe.ofFloat(0.5f, 100);//进行到一半时，progress为100
