package com.example.zhaozhihui.dailypractice.hencoder.customerview.view2;
...
public class PracticeDraw2Activity extends AppCompatActivity {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, PracticeDraw2Activity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practice_draw2);

        pager = findViewById(R.id.pager);
        pager.setAdapter(new FragmentPagerAdapter(getSupportFragmentManager()) {
            @Override
            public Fragment getItem(int position) {
                PageModel pageMode = pageModels.get(position);
                return PageFragment.newInstance(pageMode.sampleLayoutRes,pageMode.practiceLayoutRes);
            }
